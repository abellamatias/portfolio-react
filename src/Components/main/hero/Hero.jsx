    ...
    <Flex as='section' id='home' w='100%' flexDir='column' >
                <Flex as='section' w='100%' mt='130px' justify={{base:'center',lg:'space-between'}} align='center'>
                    <Flex as='section' direction='column' justify='center' basis={{base:'100%',lg:'68%'}} textAlign={{base:'center', lg:'left'}}>
                        <Text fontSize={{base:'35',sm:'51px'}} m='0 0 10px 0'>Soy <Text as='span' fontWeight='600'>Matias Ruben Abella</Text></Text>
                        <Text fontSize={{base:'20',sm:'30px'}} lineHeight='1.15'>Estudiante de Tecnicatura Universitaria en Programación y curso de Programación FullStack brindados por la UTN.</Text>
                    </Flex>
                    <Image 
                ...
                <Flex as='section' justify='space-between' align='center' w='100%' m='222px 0 0 0' flexDir={{base:'column', sm:'row'}}>
                    <Flex as='section' wrap='nowrap'>
                        {/* <!-- Lista redes --> */}
                    {redes.map((red, index) => <LinkRedes referencia={red.link} icono={red.icono} gap='15px' key={index}></LinkRedes>)}
                    </Flex>
