  ...
  return (
    // <!-- Estudios -->
                ...
                {estudios.map((estudio, index) => (
                    ...
                    {index < estudios.length - 1 && <Divider m='34px 0' borderColor='brand.black' opacity={0.2}/>}
                  </React.Fragment>))}
